...
- **[AI Configuration](./configuration.mdx)**: Set up different language model providers including Anthropic, OpenAI, Ollama, Google AI, and more
...
|---------|--------------|----------|
| Code Completion | <50ms | 95%+ |
| Inline Suggestions | <100ms | 92%+ |
| Refactoring | <2s | 98%+ |
| Code Explanation | <3s | 96%+ |
| Test Generation | <5s | 90%+ |
...
1. **[Configure your AI provider](./configuration.mdx)** - Get started in 2 minutes
...
[Start your free trial →](https://oppla.ai/download)
</Info>